def advanced_push(my_ships, team_capsule_holder enemies, enemy_capsule_holder, enemy_mothership):
    ...
    move_threshold = 4
    closest_to_capsule_holder = sorted(ships_not_assigned, key = lamda d : d.distance(enemy_capsule_holder)
    if closest_to_capsule_holder[1].can_push(enemy_capsule_holder):
        ...
        if can_be_there(closest_to_capsule_holder[1], expected_location(enemy_capsule_holder, move_threshold), move_threshold) and can_be_there(closest_to_capsule_holder[0], expected_location(enemy_capsule_holder, move_threshold), move_threshold):
